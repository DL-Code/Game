...
If TextureImage(0) then
    ...
    glTexImage2D GL_TEXTURE_2D, 0, GL_RGBA, TextureImage(0)->sizeX, TextureImage(0)->sizeY, 0, GL_RGBA, GL_UNSIGNED_BYTE, TextureImage(0)->buffer
    EndIf
    ...
    gluBuild2DMipmaps GL_TEXTURE_2D, GL_RGBA, TextureImage(0)->sizeX, TextureImage(0)->sizeY, GL_RGBA, GL_UNSIGNED_BYTE, TextureImage(0)->buffer
    EndIf
End if
